# Wedding 1860 Sheffield — Bessemer licensing/adoption horizon
...
Mss 25 image control gives the late-July sequence:

**White Lead Works → Bessemer's Stahlwerk → Cammells Walzwerke (Cyclops Works) → 26 July Leeds.**

The Bessemer and Cammell sections fall after the explicit `Mittwoch 25 Juli 1860` heading and before the explicit `Donnerstag 26 Juli: Leeds` boundary. Therefore their assignment to the 25 July Sheffield visiting sequence is a strong folio-sequence inference, not a repeated literal date.

## 2. Sheffield adoption chronology

David Hey, `The South Yorkshire Steel Industry and the Industrial Revolution`, *Northern History* 42:1 (2005), pp. 91–96, describes the East End transition as follows:

- Bessemer opens his Carlisle Street works in 1858;
- Sheffield steelmakers then begin taking licences to install converters;
- **John Brown: 1860**;
...
Source:
- https://researchframeworks.org/syrf/industrial/

Derbyshire Record Office's administrative history for Charles Cammell & Co. adds a separate production control:

- **1861:** company began making rails and railway material;
- **1863:** company began making armour plates.

Source:
- Derbyshire Record Office, Cammell Laird collection `D7806`: https://calmview.derbyshire.gov.uk/calmview/Record.aspx?AddBasket=D7806&id=D7806&src=CalmView.Catalog

These sources are consistent with, but should not be collapsed into, the licence chronology.

## 3. Why 25 July 1860 is a narrow transition window

Wedding's same-day order is now chronologically significant:

**Bessemer works → Cammell/Cyclops in July 1860**
...
Bessemer's autobiography states that his Sheffield firm was allowed to use his patents free of royalty in consideration of **permitting the works to be inspected and the process fully explained to all intending licensees**.

This institutional access arrangement and the adoption chronology should be read together, but not over-identified.

Historically grounded structure:

**demonstration/inspection site → prospective industrial adoption → licensed installation.**
...
> Wedding's portable Bessemer inscription package was produced while the process was still being actively demonstrated, explained and adopted across Sheffield, not after local standardisation was complete.

This gives the 1860 notebook pages a different evidential status from a later textbook or established works manual. The notes capture what an expert traveller selected from a process at a moment when its transfer into neighbouring industrial systems was itself still unsettled.

The same-day move from Bessemer's works to Cyclops therefore becomes analytically sharper:

**new-process demonstration site → large established steel/rolling works on the eve of its own Bessemer/rail transition.**
