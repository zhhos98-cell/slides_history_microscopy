...
- Mss 24 PDFs 66–75 have now been selectively transcribed under that layered schema after direct image control.
- Next unprocessed sequential page: **Mss 24 PDF 76**.
- Mss 24 PDFs 76–87 remain the next sequential text block.

The required five-page calibration is complete, and the same separation has been applied to PDFs 66–75. Continue PDF 76 onward with the layered fields used in those rows; do not restore the old mixed `transcription` semantics.
...
- `WEDDING_MSS24_CORRECTED_TRANSCRIPTION.jsonl`: Mss 24 ledger; PDFs 1–55 and 61–65 carry the legacy mixed-extraction warning above; PDFs 56–60 and 66–75 use the layered schema.
