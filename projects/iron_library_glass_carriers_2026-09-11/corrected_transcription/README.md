...
- Mss 24 PDFs 1–45 retain legacy mixed coverage; PDFs 46–65 have been recalibrated or cleaned into the corrected layered schema.
...
The required five-page calibration is complete, and the same separation has been applied to PDFs 46–55 and 61–87. Legacy cleanup should now continue within PDFs 1–45, not in the blank or object-view tail.
...
- `WEDDING_MSS24_CORRECTED_TRANSCRIPTION.jsonl`: Mss 24 ledger; PDFs 1–45 carry the legacy mixed-extraction warning above; PDFs 46–87 use the layered schema; PDFs 88–116 are blank or object-view tail pages.
