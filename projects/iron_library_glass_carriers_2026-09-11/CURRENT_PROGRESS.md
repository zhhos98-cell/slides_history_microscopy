...
The **Mss 23 textual sequence is complete through PDF 210**. Work has continued into **Mss 24 through PDF 15**: PDFs 6–15 now contain substantive image-controlled transcriptions of the Thüringer-Wald/Franken itinerary, route maps, geological profiles, lithological legends, measured dips/elevations and fossil lists, rather than structural markers. The final Mss 23 batch transcribes PDFs 191–203 and the complete bibliographic note on PDF 206; PDFs 204–205 and 207–210 are confirmed blank, and PDFs 211–223 are object/digitisation views. Sequential work now resumes at **Mss 24 PDF 16**. The remaining Mss 24 text and most of Mss 25 still await page-level substantive transcription. The out-of-sequence Mss 25 Bessemer cluster at PDFs 295–300 and the source heading at PDF 340 retain their separately verified readings. Any earlier statement that all 740 pages had been fully transcribed is superseded by this checkpoint.
...
Continue substantive PDF-controlled transcription in physical order, beginning with **Mss 24 PDF 16**, and synchronize each completed batch. Do not count page labels, document-mode descriptions or OCR routing text as transcription.
...
6. Corrected-transcription ledger at Mss 24 PDF 16.

**Immediate resume condition: continue at Mss 24 PDF 16.**
