...
Sequential substantive work currently runs through **Mss 23 PDF 118**; even PDFs 110–118 are blank and the next text page is PDF 119. The new batches transcribe the poor-lead-work continuation, roasting and melting operations, furnace geometry, charge/fuel/blast quantities, tapping and work-lead figures, Bleistein reworking, Bleispeise with Ni/Co/As, zinc-bearing slag, furnace campaigns, and `Die Abtreibearbeit` through silver brightening, Glätte/Abstrich classification, large/small-drive yields and Pb loss. Mss 24 and most of Mss 25 still await page-level substantive transcription. The out-of-sequence Mss 25 Bessemer cluster at PDFs 295–300 and the source heading at PDF 340 retain their separately verified readings. Any earlier statement that all 740 pages had been fully transcribed is superseded by this checkpoint.
...
Continue substantive PDF-controlled transcription in physical order, beginning with **Mss 23 PDF 119**, and synchronize each completed batch. Do not count page labels, document-mode descriptions or OCR routing text as transcription.
...
6. Corrected-transcription ledger at Mss 23 PDF 119.

**Immediate resume condition: continue at Mss 23 PDF 119, with PDF 118 confirmed blank.**
