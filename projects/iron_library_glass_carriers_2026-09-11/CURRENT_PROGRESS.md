...
Continue substantive PDF-controlled transcription in physical order, beginning with **Mss 23 PDF 109**, and synchronize each completed batch. Do not count page labels, document-mode descriptions or OCR routing text as transcription.
...
6. Corrected-transcription ledger at Mss 23 PDF 109.

**Immediate resume condition: continue `Die Abtreibearbeit` at Mss 23 PDF 109, with PDF 108 confirmed blank.**
