...
7. `HOLDINGS_TIME_MAP_2026-09-12.md` + `HOLDINGS_TIME_MAP_DENSITY_ADDENDUM_2026-09-12.md` + `CROSS_SYSTEM_OVERLAP_WINDOW_2026-09-12.md` — chronology/originality and overlap peaks c.1868–72 / c.1877–85.
8. **`ONSITE_VALUE_MAP_2026-09-12.md`** — source-access / residency-necessity map.
9. `COLLECTION_FIRST_HOLDINGS_CENSUS_2026-09-12.md` — broad census; later architecture/heat-map/evidence-regime/carrier audits override it where they differ.
...
12. `SIR_HOLDING_SYSTEM_OVERLAY_2026-09-12.md` — prior-SiR structural overlay.
13. **`COLLECTION_ACCESS_ENQUIRY_DRAFT_2026-09-12.md`** — **NOT SENT**; now includes access/reproduction, physical retrieval units, Rauschenbach internal-file structure, current 66/3/300/80 mapping, current separately-listed Library collections, Library classification export and nineteenth-century periodical holding-run export.
14. `FELLOWSHIP_EARLY_MATERIALS_MICROSCOPY_LIBRARY_ARCHIVE_PIN_2026-09-12.md` and other Sheffield–Berlin/microscopy files — subordinate hypotheses only.
15. `CURRENT_PROGRESS.md` — broad narrative history; never use alone as an authoritative checkpoint.
...
Wedding Mss 23–25 are pre-visit because full e-codices facsimiles exist. GFKS is usually material/copy-specific onsite value; GFD has essentially none.
...
Last reconciled after six-axis heat map, Tier-A carrier audit, Library large-block addendum and evidence-regime map: 2026-09-12.
