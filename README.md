...
## Slide-locked bibliography — pass 15 (2026-08-10)

The public bibliography is now at **`slide-locked-pass-15`**: **162 verified entries**, comprising **81 research/collection/conservation studies** and **81 historical primary/object records**, across **12 publication languages**. The machine-readable source of truth is `bibliography/bibliography-manifest.json`; the row data are split across `bibliography-01.csv` through `bibliography-17.csv`. The Pages bibliography reads the manifest dynamically and exports CSV, TSV, JSON, CSL JSON, BibTeX and RIS from the same rows.
...
Pass 14 added 12 East/Southeast Asian records. Japan contributes a preparation-text sequence, the Miyake-family medical-slide holdings, cleared-leaf slide catalogues, the National Museum of Nature and Science microalgae preparation collection and its slide-plus-catalogue exsiccata system; Taiwan adds a Chinese-language histological-section preparation text and a documented teaching-slide loan/return regime; Hong Kong adds an object-based malaria exhibition. Full inclusion/exclusion notes are in `docs/BIBLIOGRAPHY_PASS14_EAST_SE_ASIA_2026-08-10.md`.

Pass 15 adds **15 verified Latin American records** and produces an exact 81 research / 81 primary-object balance without changing the admission threshold. Brazil contributes three distinct Fiocruz pathology regimes: the CSAP historical collection with about 10,000 slides; the Yellow Fever Collection, whose roughly 498,000 case units link preserved liver material, paraffin blocks, stained histological glass sections and diagnostic documentation; and CDEPAT, with 240,000 stained histological glass slides linked by registration numbers to cases, blocks, documentation and publications. FMUSP adds more than 200,000 histological slides in a climate-controlled pathology `blocoteca`.

The Brazilian botanical and technical layer adds the Jardim Botânico do Rio de Janeiro wood-anatomy slide collection and the USP Herbário SPF `Laminoteca`, together with two direct slide-making studies. The JBRJ case is retained with its own metadata problem: current official pages expose 26,000, approximately 35,000 and approximately 36,000 anatomical-slide states, so no single number is silently normalized. Paiva et al. compare permanent-slide mounting media, while Quadros and Monteiro-Filho construct permanent and temporary mammal-hair reference slides using Entellan and glycerin.

Argentina contributes several different preparation economies: approximately 10,000 Diptera microscopic preparations at the Museo de La Plata; more than 6,600 preparations in the MACN national paleopalynology collection; the CTES-PMP micropaleontological section of the Rafael Herbst collection; and `Curioscopio`, a teaching kit that joins permanent preparations to an atlas and activity guides. Bodnar et al. add the historical reconstruction of the Museo de La Plata paleobotanical microscopic-preparation collection, approximately 1,600 microscope slides of fossil wood, leaf cuticles and pollen/spores, with roots in late-nineteenth/early-twentieth-century collecting and later university teaching.

Mexico and Peru add helminth repositories whose material forms remain explicit. UNAM's CNHE includes a permanent-preparation (`laminillas`) collection alongside wet and display material. UNMSM reports 3,138 helminth/invertebrate accessions divided between alcohol lots and permanent-mount slides; that mixed accession count is preserved and is not turned into a slide total.

The negative audit is equally important. The IOC entomological recovery literature remains too materially mixed for admission; UNAM's mite collection is held out pending a more bounded slide catalogue; Lamothe's 1997 parasite-preparation manual is verified bibliographically but held out because accessible records do not establish how much of the text is specifically about mounted preparations; Uruguay virtual-microscope resources remain outside the digital-whole-slide boundary; and Chilean `láminas anatómicas` search hits were anatomical teaching plates rather than microscope slides. Full notes are in `docs/BIBLIOGRAPHY_PASS15_LATIN_AMERICA_2026-08-10.md`.

Current search frontier: **Central/Eastern Europe beyond the German-language pass; residual Iberian and Latin American historical preparation catalogues; named pathological/histological teaching collections in South Asia, Sri Lanka, Singapore and southern Africa; and residual China/Korea/Southeast Asia only where dedicated physical glass-slide catalogues can be closed.** The threshold stays unchanged.
