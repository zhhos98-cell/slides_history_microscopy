...
## Slide-locked bibliography — pass 16 (2026-08-10)

The public bibliography is now at **`slide-locked-pass-16`**: **180 verified entries**, comprising **83 research/collection/conservation studies** and **97 historical primary/object records**, across **18 publication languages**. The machine-readable source of truth is `bibliography/bibliography-manifest.json`; the row data are split across `bibliography-01.csv` through `bibliography-18.csv`. The Pages bibliography reads the manifest dynamically and exports CSV, TSV, JSON, CSL JSON, BibTeX and RIS from the same rows.
...
Passes 10–15 established the institutional-register, German trade/production, France/Belgium/Austria, colonial tropical-medicine, East/Southeast Asian and Latin American modules. Their full inclusion/exclusion notes remain in the dedicated pass audit files listed above.

Pass 16 adds **18 verified Central/Eastern European records**: 16 primary/object records and two archive-based teaching publications. Poland contributes Kadyi's 1879 microscopic-section embedding paper, approximately 3,000 permanent KRAM myxomycete preparations, 11,000 UMCS entomological microscopic preparations, and the HEMIPTERON collection with more than 9,000 aphid and more than 9,000 scale-insect preparations. Czechia contributes the National Museum Prague Diptera, Hemiptera and historical small-order preparation collections plus Masaryk University's multi-generation histology teaching-slide archive.

Hungary adds Pantocsek's 918 surviving diatom preparations, the Bakony Museum's slide-catalogued 211-item Tardigrada collection and its separate 499-preparation diatom collection. Romania contributes four materially explicit Antipa Museum slide systems: Maria Suciu's 1,740 flea preparations with handwritten register, Knechtel's slide-and-coverslip Thysanoptera collection containing 3,275 specimens, the 1,831-slide Botnariuc–Albu Chironomidae collection and Manolache's 4,016 Homoptera preparations; the University of Bucharest BUC palynotheca adds a pollen-preparation subcollection under re-inventory and digitization.

Croatia contributes its national diatom collection of permanent microscopic preparations. The dated 2019 page reported more than 6,000 preparations while a current departmental history states more than 4,000; the discrepancy is preserved rather than normalized. Slovakia contributes the 2023 `Základy histológie II`, whose authors state that every histological preparation reproduced in the atlas comes from the institute's physical teaching archive. This pass adds six new publication languages—Polish, Czech, Hungarian, Romanian, Croatian and Slovak—without relaxing the threshold.

The negative audit keeps Steinhaus's broad 1905 pathological-microscopy manual, Kadyi's larger anatomical paraffin preparations, a broad Czech insect-preparation handbook, generic virtual histology resources and unbounded Serbian/Slovenian teaching pages outside the bibliography. Sofia University's geological thin-section laboratory is also held out: petrographic thin sections are a legitimate microscopic preparation medium, but adding them would constitute a new medium-domain and requires an explicit scope decision rather than opportunistic admission. Full notes are in `docs/BIBLIOGRAPHY_PASS16_CENTRAL_EASTERN_EUROPE_2026-08-10.md`.

Current search frontier: **residual Central/Eastern European historical maker and price catalogues; Iberian historical preparation catalogues; named histology/pathology glass-slide collections in South Asia, Sri Lanka, Singapore and southern Africa; and residual China/Korea/Southeast Asia only where dedicated physical slide records can be closed.** Geological thin sections remain a held-out scope decision.
